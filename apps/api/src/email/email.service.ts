...
export class EmailService {
  ...
  constructor() {
    // إعداد Nodemailer - استخدام Gmail كمثال
    // ملاحظة: للاستخدام في الإنتاج، يفضل استخدام خدمة بريد محترفة
  ...
  /**
   * إرسال بريد إلكتروني لتفعيل حساب موظف جديد
   */
  async sendEmployeeActivationEmail(
    email: string,
    employeeName: string,
    username: string,
